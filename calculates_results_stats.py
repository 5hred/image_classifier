...
def calculates_results_stats(results_dic):
    ...
    for k, v in results_dic.items():
        ...
        results_stats_dic['n_correct_breed'] += int(v[2] == 1 and v[3] == 1)  # Breed and dog

        results_stats_dic['n_correct_notdogs'] += int(not (check(v[3], 1) and check(v[4], 1)))

    results_stats_dic['n_notdogs_img'] = int(results_stats_dic['n_images'] - results_stats_dic['n_dogs_img'])
    ...
    results_stats_dic['pct_correct_breed'] = float(
            results_stats_dic['n_correct_breed'] / results_stats_dic['n_correct_dogs']) * 100
    #            pct_correct_notdogs - percentage of correctly classified NON-dogs
