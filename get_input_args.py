...
def get_input_args():
    ...
    parser.add_argument('--incorrect-dogs', action = 'store_true', help = 'Set to False to not print')
    parser.add_argument('--incorrect-breeds', action = 'store_true',
                        help = 'Set to False to not print')
